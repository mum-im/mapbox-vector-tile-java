...
public final class MvtUtil
{
	...
	/**
	 * Create a new {@link de.mum.mapbox.vectortile.VectorTile.Tile.Layer.Builder} instance with
	...
	/**
	 * Covert an {@link Object} to a new {@link de.mum.mapbox.vectortile.VectorTile.Tile.Value} instance.
	 * 
	...
	/**
	 * Convert {@link de.mum.mapbox.vectortile.VectorTile.Tile.Value} to String or boxed primitive object.
	 * 
	 * @param value target for conversion
